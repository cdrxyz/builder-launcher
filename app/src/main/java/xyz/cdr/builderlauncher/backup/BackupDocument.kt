...
data class BackupSettings(
    ...
    val oauthAccess: String? = null,
    val oauthRefresh: String? = null,
    val oauthExpiresAtEpochMs: Long? = null,
    ...
    companion object {
        fun from(settings: BuilderSettings, includeApiKey: Boolean): BackupSettings = BackupSettings(
            ...
            oauthAccess = if (includeApiKey) settings.oauthAccess else null,
            oauthRefresh = if (includeApiKey) settings.oauthRefresh else null,
            oauthExpiresAtEpochMs = if (includeApiKey) settings.oauthExpiresAtEpochMs else null,
            oauthAccount = if (includeApiKey) settings.oauthAccount else null,
