...
Tap a row for the chart. Timeframes: **1D / 1W / 1M / 3M / 1Y / 5Y**. Drag across the chart to read the price, date, and percent at that point. The [web app](../../configure/web/) opens the same detail page.
