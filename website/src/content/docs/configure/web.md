...
- **settings** — Builder account first, **auto-sync** (off / on save / 30s / 5 min; on save is default and also pulls every 5 minutes while the tab is open), weather location and units, **Include AI credentials**, S3 collapsed underneath. Sign-in and S3 save & pull ask before overwriting local data.
