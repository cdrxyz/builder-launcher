...
- **tasks** — full list. Checkbox completes a task: strikethrough, then after a second it fades to the top of completed. Tap a done line to reopen it. Tap open-row text to edit in the command bar. Done rows have an **X** to delete. Command bar starts in `-`.
