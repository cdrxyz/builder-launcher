...
- **Builder account** stores email, Argon2id password hash, session hashes, and the snapshot JSON in D1 on the Worker that serves builder.cdr.xyz. Sign-in is rate-limited.
