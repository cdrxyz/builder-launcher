...
<p align="center">
  ...
  <img src="docs/screenshots/home-ticker.png" alt="Home with weather between the clock and watchlist ticker" width="240" />
...
| `/` | `/` then pick `settings` | Slash commands listed above the bar (apps, clock, help, hub, notes, settings, stocks, weather) |
