...
Swipe up to Home (or the Home button) while already in the launcher returns to this home screen. Home from another app restores the last launcher page (tasks, hub, notes, and so on).
