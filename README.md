...
| Home | Hub | Settings |
| --- | --- | --- |
| Analog clock (timer countdown), next calendar event under the date, weather left, headphones mark, rotating ticker, last 3 todos, messages icon, command bar | Messages you can reply to | Hermes, xAI, OpenAI, Anthropic |
